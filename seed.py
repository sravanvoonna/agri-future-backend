...
def seed_database():
    ...
    # (Crop Name, Scientific Name, Season, Water Req, Yield, State Name, Suitable Soil Names list)
    crops_raw = [
        ("Rice", "Oryza sativa", "Kharif", "High", "3.5 - 4.5 tons/hectare", ["West Bengal", "Andhra Pradesh", "Punjab", "Bihar", "Chhattisgarh", "Odisha", "Tamil Nadu", "Telangana", "Assam", "Haryana", "Uttar Pradesh", "Kerala", "Tripura", "Puducherry"], ["Clayey Alluvial Soil", "Loamy Alluvial Soil", "Marshy Peaty Soil"]),
        ("Wheat", "Triticum aestivum", "Rabi", "Medium", "3.0 - 4.0 tons/hectare", ["Punjab", "Haryana", "Uttar Pradesh", "Madhya Pradesh", "Rajasthan", "Bihar", "Gujarat", "Himachal Pradesh", "Uttarakhand", "Jammu & Kashmir"], ["Loamy Alluvial Soil", "Sandy Alluvial Soil", "Deep Black Soil (Regur)"]),
        ("Maize", "Zea mays", "Kharif/Rabi", "Medium", "2.5 - 3.5 tons/hectare", ["Karnataka", "Madhya Pradesh", "Bihar", "Tamil Nadu", "Telangana", "Andhra Pradesh", "Rajasthan", "Uttar Pradesh", "Himachal Pradesh"], ["Loamy Alluvial Soil", "Sandy Alluvial Soil", "Loamy Red Soil"]),
        ("Jowar (Sorghum)", "Sorghum bicolor", "Kharif/Rabi", "Low", "1.2 - 1.8 tons/hectare", ["Maharashtra", "Karnataka", "Madhya Pradesh", "Andhra Pradesh", "Telangana", "Tamil Nadu", "Rajasthan"], ["Deep Black Soil (Regur)", "Medium Black Soil", "Shallow Black Soil"]),
        ("Bajra (Pearl Millet)", "Pennisetum glaucum", "Kharif", "Very Low", "1.0 - 1.5 tons/hectare", ["Rajasthan", "Uttar Pradesh", "Haryana", "Gujarat", "Maharashtra"], ["Sandy Desert Soil", "Sandy Red Soil", "Sandy Alluvial Soil"]),
        ("Ragi (Finger Millet)", "Eleusine coracana", "Kharif", "Low", "1.5 - 2.2 tons/hectare", ["Karnataka", "Tamil Nadu", "Uttarakhand", "Maharashtra", "Andhra Pradesh", "Jharkhand", "Sikkim", "Himachal Pradesh"], ["Sandy Red Soil", "Loamy Red Soil", "Gravelly Mountain Soil"]),
        ("Barley", "Hordeum vulgare", "Rabi", "Low", "2.0 - 3.0 tons/hectare", ["Uttar Pradesh", "Rajasthan", "Madhya Pradesh", "Haryana", "Punjab", "Himachal Pradesh", "Jammu & Kashmir"], ["Sandy Alluvial Soil", "Loamy Alluvial Soil", "Saline Desert Soil"]),
        ("Tur (Arhar)", "Cajanus cajan", "Kharif", "Low", "0.8 - 1.2 tons/hectare", ["Madhya Pradesh", "Maharashtra", "Karnataka", "Uttar Pradesh", "Gujarat", "Jharkhand"], ["Medium Black Soil", "Loamy Red Soil", "Deep Black Soil (Regur)"]),
        ("Gram (Chickpea)", "Cicer arietinum", "Rabi", "Low", "1.0 - 1.5 tons/hectare", ["Madhya Pradesh", "Rajasthan", "Maharashtra", "Karnataka", "Uttar Pradesh", "Andhra Pradesh"], ["Medium Black Soil", "Deep Black Soil (Regur)", "Red and Yellow Soil"]),
        ("Urad (Black Gram)", "Vigna mungo", "Kharif/Rabi", "Low", "0.6 - 0.9 tons/hectare", ["Madhya Pradesh", "Uttar Pradesh", "Andhra Pradesh", "Maharashtra", "Tamil Nadu", "Jharkhand"], ["Medium Black Soil", "Loamy Alluvial Soil", "Loamy Red Soil"]),
        ("Mung (Green Gram)", "Vigna radiata", "Kharif/Rabi", "Low", "0.5 - 0.8 tons/hectare", ["Rajasthan", "Maharashtra", "Andhra Pradesh", "Gujarat", "Bihar", "Odisha"], ["Sandy Alluvial Soil", "Medium Black Soil", "Sandy Desert Soil"]),
        ("Masur (Lentil)", "Lens culinaris", "Rabi", "Low", "0.9 - 1.3 tons/hectare", ["Uttar Pradesh", "Madhya Pradesh", "Bihar", "West Bengal", "Rajasthan"], ["Loamy Alluvial Soil", "Clayey Alluvial Soil", "Red and Yellow Soil"]),
        ("Groundnut", "Arachis hypogaea", "Kharif", "Medium", "1.5 - 2.5 tons/hectare", ["Gujarat", "Andhra Pradesh", "Tamil Nadu", "Karnataka", "Rajasthan", "Maharashtra"], ["Sandy Red Soil", "Loamy Red Soil", "Medium Black Soil"]),
        ("Rapeseed & Mustard", "Brassica napus", "Rabi", "Low", "1.2 - 1.8 tons/hectare", ["Rajasthan", "Haryana", "Madhya Pradesh", "Uttar Pradesh", "West Bengal", "Assam"], ["Sandy Alluvial Soil", "Loamy Alluvial Soil", "Sandy Desert Soil"]),
        ("Soyabean", "Glycine max", "Kharif", "Medium", "1.8 - 2.4 tons/hectare", ["Madhya Pradesh", "Maharashtra", "Rajasthan", "Karnataka", "Telangana"], ["Deep Black Soil (Regur)", "Medium Black Soil", "Loamy Red Soil"]),
        ("Sunflower", "Helianthus annuus", "Kharif/Rabi", "Medium", "1.2 - 1.8 tons/hectare", ["Karnataka", "Andhra Pradesh", "Maharashtra", "Bihar", "Odisha"], ["Deep Black Soil (Regur)", "Medium Black Soil", "Loamy Alluvial Soil"]),
        ("Sesame (Til)", "Sesamum indicum", "Kharif/Rabi", "Low", "0.5 - 0.7 tons/hectare", ["Gujarat", "West Bengal", "Rajasthan", "Madhya Pradesh", "Tamil Nadu"], ["Sandy Alluvial Soil", "Sandy Red Soil", "Sandy Desert Soil"]),
        ("Nigerseed", "Guizotia abyssinica", "Kharif", "Low", "0.4 - 0.6 tons/hectare", ["Karnataka", "Madhya Pradesh", "Maharashtra", "Odisha", "Jharkhand"], ["Lateritic Gravelly Soil", "Loamy Red Soil", "Medium Black Soil"]),
        ("Safflower", "Carthamus tinctorius", "Rabi", "Very Low", "0.8 - 1.2 tons/hectare", ["Maharashtra", "Karnataka", "Andhra Pradesh", "Telangana"], ["Deep Black Soil (Regur)", "Medium Black Soil", "Saline Desert Soil"]),
        ("Castor Seed", "Ricinus communis", "Kharif", "Low", "1.5 - 2.0 tons/hectare", ["Gujarat", "Rajasthan", "Andhra Pradesh", "Telangana"], ["Sandy Alluvial Soil", "Sandy Red Soil", "Medium Black Soil"]),
        ("Cotton", "Gossypium hirsutum", "Kharif", "Medium", "2.0 - 3.0 bales/hectare", ["Gujarat", "Maharashtra", "Telangana", "Andhra Pradesh", "Karnataka", "Haryana", "Punjab", "Rajasthan"], ["Deep Black Soil (Regur)", "Medium Black Soil", "Red and Yellow Soil"]),
        ("Sugarcane", "Saccharum officinarum", "Annual", "High", "70 - 80 tons/hectare", ["Uttar Pradesh", "Maharashtra", "Karnataka", "Tamil Nadu", "Andhra Pradesh", "Gujarat", "Haryana", "Bihar", "Punjab"], ["Clayey Alluvial Soil", "Loamy Alluvial Soil", "Deep Black Soil (Regur)"]),
        ("Jute", "Corchorus olitorius", "Kharif", "High", "2.2 - 2.8 tons/hectare", ["West Bengal", "Bihar", "Assam", "Odisha", "Tripura"], ["Clayey Alluvial Soil", "Loamy Alluvial Soil", "Marshy Peaty Soil"]),
        ("Mesta", "Hibiscus cannabinus", "Kharif", "Medium", "1.5 - 2.0 tons/hectare", ["Andhra Pradesh", "Odisha", "Bihar", "West Bengal", "Assam"], ["Sandy Alluvial Soil", "Loamy Red Soil", "Lateritic Gravelly Soil"]),
        ("Tea", "Camellia sinensis", "Perennial", "High", "1.8 - 2.5 tons/hectare", ["Assam", "West Bengal", "Kerala", "Tamil Nadu", "Himachal Pradesh", "Uttarakhand", "Sikkim", "Tripura"], ["Humus-rich Forest Soil", "High Altitude Laterite Soil", "Acid Forest Soil"]),
        ("Coffee", "Coffea arabica", "Perennial", "High", "0.8 - 1.2 tons/hectare", ["Karnataka", "Kerala", "Tamil Nadu", "Andhra Pradesh"], ["Humus-rich Forest Soil", "High Altitude Laterite Soil", "Lowland Laterite Soil"]),
        ("Rubber", "Hevea brasiliensis", "Perennial", "High", "1.5 - 2.0 tons/hectare", ["Kerala", "Tamil Nadu", "Tripura", "Karnataka", "Assam", "Meghalaya", "Goa"], ["Lowland Laterite Soil", "High Altitude Laterite Soil", "Loamy Red Soil"]),
        ("Potato", "Solanum tuberosum", "Rabi", "Medium", "20 - 25 tons/hectare", ["Uttar Pradesh", "West Bengal", "Bihar", "Madhya Pradesh", "Punjab", "Gujarat"], ["Loamy Alluvial Soil", "Sandy Alluvial Soil", "Loamy Red Soil"]),
        ("Tomato", "Solanum lycopersicum", "All Season", "Medium", "15 - 20 tons/hectare", ["Andhra Pradesh", "Karnataka", "Madhya Pradesh", "Maharashtra", "Odisha", "West Bengal"], ["Loamy Alluvial Soil", "Loamy Red Soil", "Medium Black Soil"]),
        ("Onion", "Allium cepa", "Rabi/Kharif", "Medium", "12 - 18 tons/hectare", ["Maharashtra", "Karnataka", "Madhya Pradesh", "Gujarat", "Bihar", "Andhra Pradesh"], ["Loamy Alluvial Soil", "Medium Black Soil", "Sandy Alluvial Soil"]),
        ("Brinjal", "Solanum melongena", "All Season", "Medium", "18 - 22 tons/hectare", ["West Bengal", "Odisha", "Bihar", "Gujarat", "Andhra Pradesh", "Chhattisgarh"], ["Loamy Alluvial Soil", "Loamy Red Soil", "Medium Black Soil"]),
        ("Cabbage", "Brassica oleracea var. capitata", "Rabi", "Medium", "25 - 30 tons/hectare", ["West Bengal", "Odisha", "Bihar", "Assam", "Karnataka"], ["Loamy Alluvial Soil", "Clayey Alluvial Soil", "Loamy Red Soil"]),
        ("Cauliflower", "Brassica oleracea var. botrytis", "Rabi", "Medium", "18 - 22 tons/hectare", ["Bihar", "West Bengal", "Uttar Pradesh", "Madhya Pradesh", "Haryana"], ["Loamy Alluvial Soil", "Clayey Alluvial Soil", "Loamy Red Soil"]),
        ("Okra (Bhindi)", "Abelmoschus esculentus", "Kharif/Summer", "Medium", "8 - 12 tons/hectare", ["Andhra Pradesh", "West Bengal", "Bihar", "Gujarat", "Okra"], ["Loamy Alluvial Soil", "Loamy Red Soil", "Medium Black Soil"]),
        ("Garlic", "Allium sativum", "Rabi", "Low", "8 - 10 tons/hectare", ["Madhya Pradesh", "Rajasthan", "Gujarat", "Uttar Pradesh", "Punjab"], ["Loamy Alluvial Soil", "Medium Black Soil", "Sandy Alluvial Soil"]),
        ("Ginger", "Zingiber officinale", "Kharif", "Medium", "12 - 15 tons/hectare", ["Kerala", "Karnataka", "Meghalaya", "Arunachal Pradesh", "Mizoram", "Sikkim", "Himachal Pradesh", "Assam"], ["Humus-rich Forest Soil", "High Altitude Laterite Soil", "Loamy Red Soil"]),
        ("Turmeric", "Curcuma longa", "Kharif", "Medium", "8 - 10 tons/hectare", ["Telangana", "Andhra Pradesh", "Tamil Nadu", "Karnataka", "Odisha", "West Bengal", "Meghalaya"], ["Loamy Alluvial Soil", "Loamy Red Soil", "High Altitude Laterite Soil"]),
        ("Black Pepper", "Piper nigrum", "Perennial", "High", "0.3 - 0.5 tons/hectare", ["Kerala", "Karnataka", "Tamil Nadu", "Puducherry"], ["Humus-rich Forest Soil", "High Altitude Laterite Soil", "Lowland Laterite Soil"]),
        ("Cardamom", "Elettaria cardamomum", "Perennial", "High", "0.2 - 0.3 tons/hectare", ["Kerala", "Karnataka", "Tamil Nadu", "Sikkim"], ["Humus-rich Forest Soil", "High Altitude Laterite Soil", "Acid Forest Soil"]),
        ("Chilli", "Capsicum annuum", "Kharif/Rabi", "Low", "1.5 - 2.5 tons/hectare", ["Andhra Pradesh", "Telangana", "Karnataka", "Tamil Nadu", "Maharashtra", "West Bengal"], ["Medium Black Soil", "Loamy Red Soil", "Loamy Alluvial Soil"]),
        ("Coriander", "Coriandrum sativum", "Rabi", "Low", "0.8 - 1.2 tons/hectare", ["Gujarat", "Madhya Pradesh", "Rajasthan", "Andhra Pradesh"], ["Loamy Alluvial Soil", "Medium Black Soil", "Sandy Alluvial Soil"]),
        ("Cumin (Jeera)", "Cuminum cyminum", "Rabi", "Very Low", "0.5 - 0.7 tons/hectare", ["Gujarat", "Rajasthan"], ["Sandy Alluvial Soil", "Sandy Desert Soil", "Loamy Alluvial Soil"]),
        ("Fennel (Saunf)", "Foeniculum vulgare", "Rabi", "Low", "1.0 - 1.5 tons/hectare", ["Gujarat", "Rajasthan", "Uttar Pradesh"], ["Sandy Alluvial Soil", "Loamy Alluvial Soil", "Medium Black Soil"]),
        ("Fenugreek (Methi)", "Trigonella foenum-graecum", "Rabi", "Low", "1.2 - 1.6 tons/hectare", ["Rajasthan", "Gujarat", "Madhya Pradesh", "Uttar Pradesh"], ["Sandy Alluvial Soil", "Loamy Alluvial Soil", "Sandy Desert Soil"]),
        ("Apple", "Malus domestica", "Perennial", "Medium", "10 - 12 tons/hectare", ["Jammu & Kashmir", "Himachal Pradesh", "Uttarakhand", "Sikkim", "Arunachal Pradesh"], ["Gravelly Mountain Soil", "Humus-rich Forest Soil", "Acid Forest Soil"]),
        ("Mango", "Mangifera indica", "Perennial", "Medium", "8 - 12 tons/hectare", ["Uttar Pradesh", "Andhra Pradesh", "Karnataka", "Bihar", "Gujarat", "Maharashtra", "West Bengal"], ["Loamy Alluvial Soil", "Loamy Red Soil", "Medium Black Soil"]),
        ("Banana", "Musa acuminata", "Annual", "High", "35 - 45 tons/hectare", ["Tamil Nadu", "Maharashtra", "Gujarat", "Andhra Pradesh", "Karnataka", "Kerala", "Puducherry"], ["Clayey Alluvial Soil", "Loamy Alluvial Soil", "Loamy Red Soil"]),
        ("Citrus (Orange)", "Citrus reticulata", "Perennial", "Medium", "12 - 15 tons/hectare", ["Maharashtra", "Madhya Pradesh", "Assam", "Punjab", "Rajasthan", "Nagaland", "Manipur"], ["Medium Black Soil", "Loamy Alluvial Soil", "Loamy Red Soil"]),
        ("Grapes", "Vitis vinifera", "Perennial", "Low", "20 - 25 tons/hectare", ["Maharashtra", "Karnataka", "Tamil Nadu", "Andhra Pradesh"], ["Medium Black Soil", "Loamy Alluvial Soil", "Loamy Red Soil"]),
        ("Guava", "Psidium guajava", "Perennial", "Low", "12 - 18 tons/hectare", ["Uttar Pradesh", "Madhya Pradesh", "Bihar", "West Bengal", "Andhra Pradesh", "Chhattisgarh"], ["Loamy Alluvial Soil", "Sandy Alluvial Soil", "Loamy Red Soil"])
    ]
